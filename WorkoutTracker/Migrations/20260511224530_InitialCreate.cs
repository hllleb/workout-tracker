        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServingSize = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: true),
                    ServingUnit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Calories = table.Column<int>(type: "int", nullable: false),
                    ProteinG = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    CarbsG = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    FatG = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
